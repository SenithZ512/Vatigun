...
public class EnemyBallFire : MonoBehaviour,IGun
{
    [SerializeField] private string _modename = "BallFire";
    ...
    public void shoot(Transform gunpoint, GunTypeSo Gundata, float finalDamage, bool isCrit, IVisitor extraVisitor = null)
    {
        ...
        GameObject bulletObj = Objectpool.Instance.SpawnFromPool("FireBall", gunpoint.position, gunpoint.rotation);
